...
const urlsToCache = [
  ...
  '/siapkak/dashboard',
  '/siapkak/js/main.js',
  '/siapkak/js/push-notifications.js',
  '/siapkak/js/ajax.js',
  '/siapkak/js/charts.js',
    ...
    if (event.data) {
        try {
            ...
            if (payload.type === 'danger' && payload.aqi_value >= 150) {
                ...
                notificationData.badge = '/siapkak/img/alert-red.png';
                ...
                notificationData.badge = '/siapkak/img/alert-orange.png';
            }
