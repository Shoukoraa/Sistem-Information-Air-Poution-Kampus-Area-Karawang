...
<body class="bg-gray-100">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-800">
                        <i class="fas fa-filter mr-2"></i>Filter Section
                    </h3>
                    <button id="refreshBtn" class="text-gray-600 hover:text-blue-600 transition" title="Reset Filter">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <!-- Station / City Filter -->
                    <div>
                        <label for="cityFilter" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-map-marker-alt mr-1"></i>Stasiun / Kota
                        </label>
                        <select id="cityFilter" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                    ...
                    <div>
                        <label for="reportType" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-calendar-alt mr-1"></i>Tipe Laporan
                        </label>
                    ...
                    <div>
                        ...
                        <input type="date" id="reportDate" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                    </div>
                </div>

                <!-- Generate Button -->
                <div class="flex justify-end">
                    <button id="applyFilterBtn" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg transition flex items-center">
    ...
    $(document).ready(function() {
        ...
        function checkAuth() {
            $.ajax({
                ...
                error: function() {
                    ...
                    window.location.href = '/siapkak/login';
                }
            });
        }
        ...
        $('#logoutBtn').on('click', function(e) {
            e.preventDefault();
            $.post('/siapkak/auth/logout.php', function() {
                window.location.href = '/siapkak/login.html';
            });
        });
