        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-6">
                    <a href="/siapkak/" class="text-gray-700 hover:text-green-600 transition">Home</a>
                    <a href="/siapkak/dashboard" class="text-gray-700 hover:text-green-600 transition">Dashboard</a>
                    <a href="/siapkak/analytics" class="text-gray-700 hover:text-green-600 transition">Analytics</a>
